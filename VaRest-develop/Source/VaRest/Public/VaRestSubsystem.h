...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FVaRestCallDelegate, UVaRestRequestJSON*, Request);
...
public:
	...
	void CallURL(const FString& URL, const TMap<FString, FString>& HeaderParameters, EVaRestRequestVerb Verb, EVaRestRequestContentType ContentType, UVaRestJsonObject* VaRestJson, FVaRestCallDelegate& Callback);
