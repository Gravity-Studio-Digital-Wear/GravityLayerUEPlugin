...
void UVaRestSubsystem::CallURL(const FString& URL, const TMap<FString, FString>& HeaderParameters, EVaRestRequestVerb Verb, EVaRestRequestContentType ContentType, UVaRestJsonObject* VaRestJson, FVaRestCallDelegate& Callback)
{
	...
	for (auto& Elem : HeaderParameters)
	{
...
void UVaRestSubsystem::OnCallComplete(UVaRestRequestJSON* Request)
{
	...
	Response->Callback.Broadcast(Request);
